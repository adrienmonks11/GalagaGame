...
# Represents an explosion when an enemy dies
class EnemyExplosion(arcade.Sprite):
    def __init__(self, xpos, ypos):
        super().__init__("sprites/player_explosion/1.png", EXPLOSION_SCALING)
        self.explosion_textures = [arcade.load_texture("sprites/enemy_explosion/1.png"), arcade.load_texture("sprites/enemy_explosion/2.png"), arcade.load_texture(
            "sprites/enemy_explosion/3.png"), arcade.load_texture("sprites/enemy_explosion/4.png"), arcade.load_texture("sprites/enemy_explosion/5.png")]
        self.cur_texture = 0
        self.center_x = xpos
        self.center_y = ypos
